...
public class FactionModAPI {
    ...
    public static class ExperienceAPI {
        ...
        /**
         * Adds the specified amoutn of experience to the specified
         * {@link Faction}.
         * 
         * @param faction
         *            The {@link Faction}
         ...
         * @param member
         *            The UUID of the player who made the {@link Faction} win
         *            the experience, can be null
         */
        ...
        /**
         * Sets the level and the experience of a {@link Faction}. The level has
         * to be greater than 0 and the experience equals to or greater than 0.
         * 
         * @param faction
         *            The {@link Faction}
         * @param level
    ...
    public static class FactionAPI {
        ...
        /**
         * Returns the {@link Faction} with the specified name. If no
         * {@link Faction} has this name, it will return {@code null}.
         * 
         * @param name
        ...
        /**
         * Returns a random {@link Faction} or null if there is no
         * {@link Faction} registered.
         * 
         * @param rand
    ...
    public static class ChunkAPI {
        ...
        /**
         * Indicates if a chunk at the specified {@link DimensionalPosition} is
         * managed by an instance of {@link IChunkManager}.
         * 
         * @param position
         ...
         * specified {@link DimensionalPosition}. Returns null if the
         * {@link Chunk} isn't managed.
         * 
         * @param position
        ...
        /**
         * Sets the specified {@link IChunkManager} for a {@link Chunk}. It
         * overrides the previous {@link IChinkManager}. You can use
         * {@link ChunkManagerCreator} to easily create {@link IChunkManager}s.
         * 
         * @param manager
         ...
         *            The {@link DimensionalPosition} of the {@link Chunk}
         * @param instance
         *            The {@link ZoneInstance} which permits to retrieve the
         *            instance of the {@link IChunkManager}
         */
