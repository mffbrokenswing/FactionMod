...
public class MessageHelper {
	...
	public static ITextComponent info(String message) {
		return new TextComponentString(PREFIX + message).setStyle(new Style().setColor(INFO_COLOR));
	}
	 ...
	 * @return a chat component
	 */
	public static ITextComponent warn(String message) {
		return new TextComponentString(PREFIX + message).setStyle(new Style().setColor(WARN_COLOR));
	}
	...
	public static ITextComponent error(String message) {
		return new TextComponentString(PREFIX + message).setStyle(new Style().setColor(ERROR_COLOR));
	}
	 ...
	 */
	public static ITextComponent message(String message, int level) {
		switch (level) {
			case INFO:
				return info(message);
			case WARN:
			...
			default:
				return new TextComponentString(PREFIX + message);
		}
	}
